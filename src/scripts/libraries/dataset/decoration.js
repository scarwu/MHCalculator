...
// Load Dataset
import WorldDecorations from '@/scripts/datasets/world/decorations.json'
import RiseDecorations from '@/scripts/datasets/rise/decorations.json'

let mapping = {
    world: WorldDecorations,
    rise: RiseDecorations,
    wilds: null
}
...
const getDataset = () => {
    ...
    return mapping[series].map((decorationItem) => {
        return {
            id: decorationItem[0],
...
export default new DecorationDataset(getDataset())
