...
const handleItemPickUp = (itemId, dataStore) => {
    if ('playerEquips' === dataStore.target) {
        States.actions.setPlayerEquip(dataStore.equipType, itemId)
    }

    if ('requiredConditions' === dataStore.target) {
        States.actions.setRequiredConditionsEquip(dataStore.equipType, itemId)
    }

    States.actions.showModal('armorSelector', {
...
export default function ArmorSelectorModal (props) {
    ...
    const handleTypeChange = useCallback((event) => {
        ...
        if (Helper.isNotEmpty(stateTempData.target)) {
            States.actions.showModal(targetModalKey, {
