            ...
            <div className="col-12 mhc-name">
                ...
                <div className="mhc-icons_bundle">
                    <IconButton
                        ...
                        onClick={() => {
                            States.actions.decreaseRequiredConditionsSetCount(setItem.id)
                        }} />
                    <IconButton
                        iconName="plus-circle" altName={_('up')}
                        onClick={() => {
                            States.actions.increaseRequiredConditionsSetCount(setItem.id)
                        }} />
                    <IconButton
                        iconName="times" altName={_('clean')}
                        onClick={() => {
                            States.actions.removeRequiredConditionsSet(setItem.id)
                        }} />
                </div>
            </div>
        </div>
...
export default function SetList (props) {
    ...
    return useMemo(() => {
        ...
        const showModal = () => {
            States.actions.showModal('setSelector', {
