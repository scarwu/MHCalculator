 ...
 */
 const renderRampageSkillOption = (rampageSkillIndex, rampageSkillId) => {
    ...
    const showModal = () => {
        States.actions.showModal('rampageSkillSelector', {
            target: 'playerEquips',
    ...
    const removeItem = () => {
        States.actions.setPlayerEquipRampageSkill('weapon', rampageSkillIndex, null)
    }
...
const renderDecorationOption = (equipType, slotIndex, slotSize, decorationId) => {
    ...
    const showModal = () => {
        States.actions.showModal('decorationSelector', {
            target: 'playerEquips',
            equipType: equipType,
            idIndex: slotIndex,
    ...
    const removeItem = () => {
        States.actions.setPlayerEquipDecoration(equipType, slotIndex, null)
    }
...
const renderEquipPartBlock = (equipType, currentEquipData, requiredEquipData) => {
    ...
    const showModal = () => {
        States.actions.showModal(Misc.equipTypeToDatasetType(equipType) + 'Selector', {
            target: 'playerEquips',
            equipType: equipType
        })
    }
    ...
    const removeItem = () => {
        States.actions.setPlayerEquip(equipType, null)
    }
                    ...
                    <div className="mhc-icons_bundle">
                        {'weapon' === equipType || 'charm' === equipType ? (
                            <IconButton
                                ...
                                onClick={() => {
                                    States.actions.setPlayerEquip(equipType, 'custom' + Helper.ucfirst(equipType))
                                }} />
                        ) : false}
                        {'charm' !== equipType ? (
                            <IconButton iconName="plus" altName={_('add')} onClick={showModal} />
                ...
                <div className="mhc-icons_bundle">
                    {'petalace' !== equipType && isNotRequire ? (
                        <IconButton
                            ...
                            onClick={() => {
                                States.actions.replaceRequiredConditionsEquipData(equipType, currentEquipData)
                            }} />
                    ) : false}
                    {'weapon' === equipType || 'charm' === equipType ? (
                        <IconButton
