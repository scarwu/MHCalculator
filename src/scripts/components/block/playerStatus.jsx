...
const generateEquipInfos = (equips) => {
    ...
    //     let customWeapon = States.getters.customWeapon()
...
export default function PlayerStatusBlock (props) {
     ...
     * Hooks
     */
    const _playerStatus = States.hooks.usePlayerStatus()
                        ...
                        <div className="col-6 mhc-value">
                            ...
                            <div className="mhc-icons_bundle">
                                <IconButton
                                    ...
                                    onClick={() => {
                                        States.actions.togglePlayerStatusUsingItem('powerCharm')
                                    }} />
                            </div>
                        </div>
                        ...
                        <div className="col-6 mhc-value">
                            ...
                            <div className="mhc-icons_bundle">
                                <IconButton
                                    ...
                                    onClick={() => {
                                        States.actions.togglePlayerStatusUsingItem('armorCharm')
                                    }} />
                            </div>
                        </div>
                        ...
                        <div className="col-6 mhc-value">
                            ...
                            <div className="mhc-icons_bundle">
                                <IconButton
                                    ...
                                    onClick={() => {
                                        States.actions.togglePlayerStatusUsingItem('powerTalon')
                                    }} />
                            </div>
                        </div>
                        ...
                        <div className="col-6 mhc-value">
                            ...
                            <div className="mhc-icons_bundle">
                                <IconButton
                                    ...
                                    onClick={() => {
                                        States.actions.togglePlayerStatusUsingItem('armorTalon')
                                    }} />
                            </div>
                        </div>
                    </div>
