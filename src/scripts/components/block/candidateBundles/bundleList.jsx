...
const handleBundlePickUp = (bundle, requiredConditions) => {
    let playerEquips = Helper.deepCopy(States.getters.playerEquips())
    let slotMetaMap = {
        1: [],
        2: [],
        3: []
...
export default function BundleList (props) {
    ...
    const handleDecorationPackageChange = useCallback((bundleIndex, packageIndex) => {
        ...
        States.actions.replaceCandidateBundles(candidateBundles)
    }, [_candidateBundles])
                        ...
                        <div className="col-12 mhc-content">
                            {bundleEquipList.map((bundleEquipData) => {
                                ...
                                return Helper.isNotEmpty(equipItem) ? (
                                    <div key={bundleEquipData.type} className="col-6 mhc-value">
                                        ...
                                        <div className="mhc-icons_bundle">
                                            {isNotRequire ? (
                                                <IconButton
                                                    ...
                                                    onClick={() => {
                                                        States.actions.replaceRequiredConditionsEquipData(bundleEquipData.type, bundleEquipData)
                                                    }} />
                                            ) : false}
                                        </div>
                                    </div>
                                            ...
                                            {(-1 === requiredSetIds.indexOf(setItem.id)) ? (
                                                <div className="mhc-icons_bundle">
                                                    <IconButton
                                                        iconName="arrow-left" altName={_('include')}
                                                        onClick={() => {
                                                            States.actions.addRequiredConditionsSet(setItem.id)
                                                        }} />
                                                </div>
                                            ) : false}
                                        </div>
                            ...
                            <div className="col-12 mhc-content">
                                {additionalSkills.map((skillData) => {
                                    ...
                                    return (Helper.isNotEmpty(skillItem)) ? (
                                        <div key={skillData.id} className="col-6 mhc-value">
                                            ...
                                            {(-1 === requiredSkillIds.indexOf(skillItem.id)) ? (
                                                <div className="mhc-icons_bundle">
                                                    <IconButton
                                                        iconName="arrow-left" altName={_('include')}
                                                        onClick={() => {
                                                            States.actions.addRequiredConditionsSkill(skillItem.id)
                                                        }} />
                                                </div>
                                            ) : false}
                                        </div>
