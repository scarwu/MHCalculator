...
import QuickSetting from '@/scripts/components/block/candidateBundles/quickSetting'
import RequiredConditions from '@/scripts/components/block/candidateBundles/requiredConditions'
import BundleList from '@/scripts/components/block/candidateBundles/bundleList'
...
export default function CandidateBundlesBlock (props) {
     ...
     * Hooks
     */
    const _dataStore = States.hooks.useDataStore()
    const _candidateBundles = States.hooks.useCandidateBundles()
    ...
    useEffect(() => {
        Event.on('workerCallback', 'tasks', (data) => {
            ...
            case 'progress':
                ...
                break
            case 'result':
                States.actions.switchDataStore('candidateBundles', tabIndex)
                States.actions.replaceCandidateBundles(payload.candidateBundles)
    ...
    const handleCandidateBundlesSearch = useCallback(() => {
        ...
        let requiredConditions = States.getters.requiredConditions()
        let algorithmParams = States.getters.algorithmParams()
